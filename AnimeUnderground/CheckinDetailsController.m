...
- (id)initWithSerie:(Serie*) serieAux {
    ...
    if (self) {
        ...
        serie = [serieAux retain];
        capitulosCheck = [[[NSMutableArray alloc]initWithCapacity:serie.capitulosTotales]retain];
    }
...
- (void)viewDidLoad
{
    ...
    self.title = [@"Checkin " stringByAppendingString:serie.nombre];
